 ...
 * @description
 */
public class BPatientInfoResultForm {
    private static final long serialVersionUID = -7320798312136144765L;

    private String id;
    private String name;
    private String kana; //拼音
    ...
    private String firstdialysisdate;
    ...
    private String localfirstdialysisdate;
    ...
    public String getFirstdialysisdate() {
        return firstdialysisdate;
    }

    public void setFirstdialysisdate(String firstdialysisdate) {
        this.firstdialysisdate = firstdialysisdate;
    }

    public String getFirsttreatmentdate() {
        return firsttreatmentdate;
    }

    public void setFirsttreatmentdate(String firsttreatmentdate) {
    ...
    public String getAddrdistance() {
        return addrdistance;
    }

    public void setAddrdistance(String addrdistance) {
    ...
    public String getLocalfirstdialysisdate() {
        return localfirstdialysisdate;
    }

    public void setLocalfirstdialysisdate(String localfirstdialysisdate) {
